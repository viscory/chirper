...
const Admin = () => {
  ...
  // If user is not the admin, redirect to home page
  React.useEffect(() => {
  ...
  // Return the main content of the admin page
  return (
        ...
        <div className='flex gap-6'>
          <div className='sm:ml-20 xl:ml-[340px] w-[600px] min-h-screen border-r border-gray-400 text-black dark:text-white py-2'>
            <div className="px-2">
              ...
              <div className="mt-6">
                {
                  // Map through all users and display their information, with a delete button for each
